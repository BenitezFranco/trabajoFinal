            ...
            <div className="flex-grow bg-gray-100 p-6">
                <div className="grid grid-cols-7 grid-rows-4 gap-6 max-w-6xl mx-auto">
                    ...
                    <div className="col-span-3 row-span-4 bg-white p-6 rounded-xl shadow-lg">
                        <h1 className="text-3xl font-semibold text-center text-gray-800 mb-6">Buscar Recetas o Usuarios</h1>

                        {/* Selector de modo de búsqueda */}
                        <div className="flex justify-center space-x-4 mb-6">
                            <button
                                onClick={() => handleModoBusquedaChange('receta')}
                                className={`py-2 px-6 rounded-full transition-all duration-300 transform hover:scale-105 ${modoBusqueda === 'receta' ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-300 text-gray-800'
                                    }`}
                            >
                                Buscar por Receta
                            </button>
                            <button
                                ...
                                className={`py-2 px-6 rounded-full transition-all duration-300 transform hover:scale-105 ${modoBusqueda === 'usuario' ? 'bg-green-600 text-white shadow-md' : 'bg-gray-300 text-gray-800'
                                    }`}
                            >
                                Buscar por Usuario
                            </button>
